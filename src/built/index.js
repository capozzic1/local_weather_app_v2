...
var LocalWeather = /** @class */ (function () {
    function LocalWeather(location, temp, description, humidity, icon, celsius, lat) {
    ...
    LocalWeather.getCoords = function () {
        fetch('https://geoip.nekudo.com/api')
            ...
            var weatherURL = "https://cors-anywhere.herokuapp.com/http://api.openweathermap.org/data/2.5/weather?lat=" + this.lat + "&lon=" + this.long + "&units=imperial&APPID=ef73411c829a4563b61b64e76cb72976";
            //console.log(this.long);
        });
        //console.log(test)
    };
    LocalWeather.prototype.getWeatherData = function () { };
    return LocalWeather;
}());
